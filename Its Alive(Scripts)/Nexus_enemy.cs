...
public class Nexus_enemy : MonoBehaviour
{
   ...
   /* private void OnMouseDown()
    {
        ...
        health_bar_HUD.maxValue = this.gameObject.GetComponent<Nexus_enemy>().health_bar.maxValue;
        health_bar_HUD.value = this.gameObject.GetComponent<Nexus_enemy>().health_bar.value;
        /////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        vida_txt.text = "" + this.gameObject.GetComponent<Nexus_enemy>().health_bar.value + "/" + this.gameObject.GetComponent<Nexus_enemy>().health_bar.maxValue;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void Update()
    {
        ...
        if ((this.health_bar.value * 100) / this.health_bar.maxValue <= 70 && (this.health_bar.value * 100) / this.health_bar.maxValue >= 36)
        {
            this.fillColor.color = Color.yellow;
        }
        else if ((this.health_bar.value * 100) / this.health_bar.maxValue <= 35)
        {
            this.fillColor.color = Color.red;

        }
        else if ((this.health_bar.value * 100) / this.health_bar.maxValue >= 71)
        {
        ...
        if (CanSee(distanceatk) == "inimigo")
        {
            ...
            GameManager.bateuNexusenemy = true;
        ...
        if (atkCD <= 0f)
        {
            ...
            if (hit.collider != null)
            {
                ...
                if (hit.collider.gameObject.CompareTag("player"))
                {
                    ...
                    hit.collider.gameObject.GetComponent<Player_combat>().health_bar.value -= 10;
    ...
    string CanSee(float distancia)
    {
        ...
        if (hit.collider != null)
        {
            if (hit.collider.gameObject.CompareTag("player"))
            {
                atk_speed_enemy = hit.collider.gameObject.GetComponent<Player_combat>().atkspeed;
                force_enemy = hit.collider.gameObject.GetComponent<Player_combat>().force;
